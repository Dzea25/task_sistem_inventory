                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <?php 
                                    $id_user = $_SESSION['id'];
                                    $profil = $myConn->query("select * from user where user_id='$id_user'");
                                    while($p = $profil->fetch_array()){
                                ?>
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $p['user_nama']; ?></span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="gantipassword.php">
                                    <i class="fas fa-lock fa-sm fa-fw mr-2 text-gray-900"></i>
                                    Ganti Password
                                </a>
                                <a class="dropdown-item" href="#">
                                    <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-900"></i>
                                    Activity Log
                                </a>
